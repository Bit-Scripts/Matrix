...
static PyObject *impl_numpy$lib$nanfunctions$$$function__7_nanmin(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
...

    {
...

        {
            ...
            tmp_assign_source_8 = impl___main__$$$function__13_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
    ...
    }
    {
...

        {
            ...
            tmp_assign_source_9 = impl___main__$$$function__13_complex_call_helper_pos_keywords_star_dict(tstate, dir_call_args);
        }
